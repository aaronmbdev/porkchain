...
export CORE_PEER_TLS_CERT_FILE="${PWD}"/crypto-config/peerOrganizations/factory.meatchain.cloud/peers/peer0.factory.meatchain.cloud/tls/server.crt
export CORE_PEER_TLS_KEY_FILE="${PWD}"/crypto-config/peerOrganizations/factory.meatchain.cloud/peers/peer0.factory.meatchain.cloud/tls/server.key
...
export CORE_PEER_ID=peer0.factory.meatchain.cloud
...
export CORE_PEER_MSPCONFIGPATH="${PWD}"/crypto-config/peerOrganizations/factory.meatchain.cloud/peers/peer0.factory.meatchain.cloud/msp
export CORE_OPERATIONS_LISTENADDRESS=127.0.0.1:8447
export CORE_PEER_FILESYSTEMPATH="${PWD}"/data/peer0.factory.meatchain.cloud
export CORE_LEDGER_SNAPSHOTS_ROOTDIR="${PWD}"/data/peer0.factory.meatchain.cloud/snapshots
