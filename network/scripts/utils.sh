...
function printHelp() {
  ...
  if [ "$USAGE" == "up" ]; then
    ...
    println "   \033[0;32mup\033[0m -r -s -verbose"
    println "   \033[0;32mup createChannel\033[0m -c -r -s -verbose"
    println
    println " Examples:"
    println "   network.sh up createChannel -c mychannel -s couchdb "
    ...
    println
    println " Possible Mode and flag combinations"
    println "   \033[0;32mcreateChannel\033[0m -c -r -verbose"
    println
    println " Examples:"
    ...
    println "   \033[0;32mdeployCC\033[0m -ccn -ccl -ccv -ccs -ccp -cci -r -verbose"
    println
    println " Examples:"
