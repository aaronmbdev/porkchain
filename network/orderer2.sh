...
export ORDERER_GENERAL_LOCALMSPDIR="${PWD}"/crypto-config/ordererOrganizations/meatchain.cloud/orderers/orderer2.meatchain.cloud/msp
export ORDERER_GENERAL_TLS_ENABLED=true
export ORDERER_GENERAL_TLS_PRIVATEKEY="${PWD}"/crypto-config/ordererOrganizations/meatchain.cloud/orderers/orderer2.meatchain.cloud/tls/server.key
export ORDERER_GENERAL_TLS_CERTIFICATE="${PWD}"/crypto-config/ordererOrganizations/meatchain.cloud/orderers/orderer2.meatchain.cloud/tls/server.crt
...
export ORDERER_GENERAL_TLS_ROOTCAS="${PWD}"/crypto-config/ordererOrganizations/meatchain.cloud/orderers/orderer2.meatchain.cloud/tls/ca.crt
