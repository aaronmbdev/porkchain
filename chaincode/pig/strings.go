...
const (
	...
	error_not_an_additive          = "The entity requested is not an Additive"
	...
	error_meat_quantity_wont_match = "The array of sizes is not matching the array of meats, check your inputs"
	error_meat_not_enough_pieces   = "The meat %s does not have enough pieces, required %d but %d available"
)
